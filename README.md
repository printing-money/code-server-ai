...
The current release line is `4.129.0-jack.1`. Install the official extensions
at their tested versions with:
...
installer downloads the official Marketplace artifacts at the pinned versions
in `compatibility/ai-extensions.json`.
